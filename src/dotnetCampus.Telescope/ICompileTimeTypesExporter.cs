...
public interface ICompileTimeTypesExporter<TBaseClassOrInterface, TAttribute>
    where TAttribute : Attribute
{
    ...
    ExportedTypeMetadata<TBaseClassOrInterface, TAttribute>[] ExportTypes();
}

public class ExportedTypeMetadata<TBaseClassOrInterface, TAttribute>
    where TAttribute : Attribute
{
    private readonly Func<TBaseClassOrInterface> _instanceCreator;

    public ExportedTypeMetadata(Type realType, Func<TBaseClassOrInterface> instanceCreator)
    {
