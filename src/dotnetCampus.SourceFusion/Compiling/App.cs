...
using System.Linq;
using System.Text;
using dotnetCampus.Compiling.Cli;
using dotnetCampus.Compiling.Core;
using dotnetCampus.Compiling.Templates;
using dotnetCampus.Compiling.Transforming;
using dotnetCampus.Compiling.Utils;

namespace dotnetCampus.Compiling
{
    internal class App
    {
